      ...
      <div className="relative z-20 max-w-7xl lg:mt-30 px-8 py-10 mx-auto text-left w-full h-full flex flex-col justify-end md:justify-center md:text-left">
        <div className="max-w-xl md:max-w-2xl lg:max-w-3xl">
          <h1
            ...
            data-aos="fade-right"
          >
            Hi, I'm <span className="underline decoration-blue-400">Umar Nazir</span>
          </h1>
          <h2
          ...
          <div
            ...
            data-aos-delay="600"
          >
            <button className="bg-blue-500 hover:bg-blue-600 text-white px-14 py-4 rounded-lg font-semibold text-lg transition transform hover:scale-105 shadow-lg">
              View My Work
            </button>
            <button className="border-2 border-white text-white hover:bg-white hover:text-black px-14 py-4 rounded-lg font-semibold text-lg transition transform hover:scale-105">
              Download CV
            </button>
          </div>
        </div>
