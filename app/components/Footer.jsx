      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 mb-12">
            ...
            >
              <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-full flex items-center justify-center shadow-lg group-hover:shadow-blue-500/25">
          ...
          {/* Divider */}
          <div className="w-32 h-px bg-gradient-to-r from-transparent via-slate-600 to-transparent mx-auto mb-8"></div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-center gap-2 text-slate-400 group">
              ...
              <Heart 
                className="w-4 h-4 text-white animate-pulse group-hover:scale-125 transition-transform duration-300" 
                fill="currentColor" 
              />
