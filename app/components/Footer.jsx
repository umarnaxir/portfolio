        ...
        <div className="text-center  mx-auto">
          ...
          <div className="mb-4">
            <h2 className="text-3xl font-bold mb-2">
              <span className="text-white">Umar Nazir</span>
            </h2>
            <p className="text-white text-base px-2 leading-relaxed md:w-6xl">
              A dedicated Computer Science
              Engineer and passionate Software Developer specializing in
              front-end technologies. Alongside my development expertise, I
              bring 2 years of professional experience as a Front-End Developer, SEO Executive,
              WordPress Developer, and Graphic Designer, delivering impactful
              digital solutions that combine technical precision with creative
              design.
            </p>
          </div>
